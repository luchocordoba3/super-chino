...
const INT_FIELDS = new Set<NumField>(['expiryAlertDays', 'offerAllowBelowCostDays', 'voidAlertThreshold', 'countItemsPerDay', 'aiDailyScanLimit', 'lateToleranceMin', 'absentAfterMin']);
